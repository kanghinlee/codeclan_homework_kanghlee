...
```{r}
# back_pain_1 <- as.numeric(sum(main_backpack$back_problems == 1))
# back_pain_0 <- as.numeric(sum(main_backpack$back_problems == 0))
# back_pain_total = as.numeric(nrow(main_backpack))
# back_pain_ratio = back_pain_1 / back_pain_0
# back_pain_ratio
